...
| Setting | Type   | Description                                                                                                                                                                                                                                                                                                  | Default     |
| ------- | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------- |
| `proxy` | string | HTTP/HTTPS proxy URL used for outbound network calls (e.g. `http://user:pass@host:port`). Values without a scheme are treated as `http://`. SOCKS proxies are not supported. The `--proxy` CLI flag and the `HTTPS_PROXY`/`HTTP_PROXY` environment variables take precedence over this value, in that order. | `undefined` |
